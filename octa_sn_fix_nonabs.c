// 八面体シミュレーション
// octa_sampling_sn_nonabs.c を元に推定したSPB,核小体の安定点に対して
// 核小体の配向を推定する
...
void Calculation (const unsigned int mitigation, Nuc *nuc, Spb *spb, const double k_sn, double nuc_gravity[DIMENSION]) {
